...
//        add anonymous user to db then get his id
        UserDAO daoU = new UserDAO();
        String userId = daoU.commentUser(author);
        
//      if commentUser == null, then user already logged in, the get acc session
        if(userId == null){
...
//        after getting user id, use the id to insert comment to db
        CommentDAO daoComment = new CommentDAO();
        daoComment.addCComment(articleId, userId, comment);
